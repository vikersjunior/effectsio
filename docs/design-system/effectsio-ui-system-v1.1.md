# EffectsIO UI System
## V1.1 Beta — Canonical Product UI, Branding & Interaction System

**Status:** Canonical  
**Product:** EffectsIO  
**Companion:** `effectsio-component-system-v1.1.md`  
...
- `PRD.md` defines **what EffectsIO is and what it must do**.
- `docs/design-system/component-rules.md` defines the current repository component contract.
- This document defines the **visual and interaction direction**.
- `effectsio-component-system-v1.1.md` defines **which component should be used for which semantic job**.
...
The v1.1 Beta visual identity uses a restrained pink accent against a near-black neutral interface.
...
effectsio-ui-system-v1.1.md
  ↓
Visual + interaction direction

effectsio-component-system-v1.1.md
  ↓
