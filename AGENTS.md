...
5. **Rule 5 — Icons**: Use `@phosphor-icons/react` for UI icons throughout the application shell (using default regular weight with contextual fill/light variants where designated).
