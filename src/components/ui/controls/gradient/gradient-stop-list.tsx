  ...
  return (
    <InputGroup className="w-14 flex-none rounded-l-none [&:not(:focus-within):hover]:!border-[color:color-mix(in_oklab,var(--border)_20%,transparent)] [&:not(:focus-within):hover]:text-[color:var(--foreground)]">
      <InputGroupInput
        ...
        autoComplete="off"
        className="pl-[5px] pr-1 text-right font-mono text-xs"
        inputMode="numeric"
      ...
      <InputGroupAddon align="inline-end" className="pr-1.5 pl-0">
        <InputGroupText className="group-hover/input-group:text-[color:var(--foreground)] text-xs">
          %
        </InputGroupText>
      </InputGroupAddon>
    </InputGroup>
  ...
  return (
    <InputGroup className="min-w-0">
      <InputGroupInput
        ...
        autoComplete="off"
        className="pl-[5px] pr-1 text-left font-mono text-xs"
        inputMode="numeric"
...
export function GradientStopsList({
  ...
  return (
    <div
      className="flex min-w-0 flex-col gap-1 w-full"
