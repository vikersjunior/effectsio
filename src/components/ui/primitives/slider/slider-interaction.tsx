...
export function useSliderInteractionValueChange<Value extends SliderRuntimeValue>({
  disabled,
  handleValueChange,
  max,
  min,
...
}): (nextValue: SliderValue<Value>, eventDetails: SliderPrimitive.Root.ChangeEventDetails) => void {
