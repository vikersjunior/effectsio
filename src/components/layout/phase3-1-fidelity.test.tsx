...
describe("Phase 3.1: Figma Fidelity Workspace Components", () => {
  ...
  describe("1. ProjectNameInput", () => {
    it("renders initial project name as non-editing button", () => {
      ...
      const nameElement = screen.getByRole("button", { name: /Project Name: Project Name/i });
    ...
    it("enters editing mode on click and commits on Enter", () => {
      ...
      const button = screen.getByRole("button", { name: /Project Name: Project Name/i });
      ...
      const updated = screen.getByRole("button", { name: /Project Name: Summer Campaign 2026/i });
    ...
    it("cancels editing and reverts on Escape", () => {
      ...
      const reverted = screen.getByRole("button", { name: /Project Name: Project Name/i });
  ...
  describe("3. CanvasControlDock", () => {
    it("renders timeline playback and viewport controls in exact Figma grouping", () => {
      ...
      expect(screen.getByRole("toolbar", { name: /Canvas Workspace Controls/i })).toBeDefined();
